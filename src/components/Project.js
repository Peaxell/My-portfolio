...
const Projects = () => {
  const projects = [
    ...
    { title: "Modern E-Commerce Redesign", description: "Redesigned an e-commerce demo site to improve usability, resulting in better rendition and accessibility.", img: image3 },
  ];
